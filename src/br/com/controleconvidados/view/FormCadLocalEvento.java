...
public class FormCadLocalEvento extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTextFieldProprietário = new javax.swing.JTextField();
        ...
        jPanelCliente.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createEtchedBorder(), "Dados do Proprietário"));

        jLabel2.setText("Proprietário");

        jTextFieldLocal.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                jTextFieldLocalKeyReleased(evt);
            }
        });
        ...
        jTextFieldProprietário.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                jTextFieldProprietárioKeyReleased(evt);
            }
        });
                    ...
                    .addGroup(jPanelClienteLayout.createSequentialGroup()
                        ...
                        .addGroup(jPanelClienteLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanelClienteLayout.createSequentialGroup()
                                ...
                                .addGap(18, 18, 18)
                                .addComponent(jFormattedTextCpfCNPJ, javax.swing.GroupLayout.PREFERRED_SIZE, 110, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(0, 0, Short.MAX_VALUE))
                            .addGroup(jPanelClienteLayout.createSequentialGroup()
                                .addComponent(jLabel4)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                .addComponent(jTextFieldLocal, javax.swing.GroupLayout.PREFERRED_SIZE, 189, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(jPanelClienteLayout.createSequentialGroup()
                                .addComponent(jLabel2)
                                .addGap(23, 23, 23)
                                .addComponent(jTextFieldProprietário)))))
                .addContainerGap())
        );
        jPanelClienteLayout.setVerticalGroup(
            ...
            .addGroup(jPanelClienteLayout.createSequentialGroup()
                ...
                .addGroup(jPanelClienteLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel2)
                    .addComponent(jTextFieldProprietário, javax.swing.GroupLayout.PREFERRED_SIZE, 23, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                .addGroup(jPanelClienteLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                ...
                .addGroup(jPanelClienteLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel4)
                    .addComponent(jTextFieldLocal, javax.swing.GroupLayout.PREFERRED_SIZE, 23, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(86, 86, 86)
                .addComponent(jLabel3)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );

        getContentPane().add(jPanelCliente, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 130, 290, 180));
        ...
        getContentPane().add(jPanelCli, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 50, 290, 60));
    ...
    private void jTextFieldLocalKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextFieldLocalKeyReleased
        jTextFieldLocal.setText(jTextFieldLocal.getText().toUpperCase());
    }//GEN-LAST:event_jTextFieldLocalKeyReleased
    ...
    //Cadastro de Endereços
     ...
     //Cadastro de cliente
        try {
            ...
            cli.setNome_cliente(jTextFieldLocal.getText());
  ...
  //Cadastro de Contatos
    ...
    private void jTextFieldProprietárioKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextFieldProprietárioKeyReleased
        jTextFieldProprietário.setText(jTextFieldProprietário.getText().toUpperCase());
    }//GEN-LAST:event_jTextFieldProprietárioKeyReleased
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormCadLocalEvento.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormCadLocalEvento().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTextField jTextFieldProprietário;
